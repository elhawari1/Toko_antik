<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('kategori/gucci') ?>">
        <i class="fas fa-flask"></i>
          <span>Gucci</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('kategori/patung') ?>">
        <i class="fas fa-dragon"></i>
          <span>Patung</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('kategori/teko') ?>">
        <i class="fas fa-flask"></i>
          <span>Teko</span></a>
      </li>
